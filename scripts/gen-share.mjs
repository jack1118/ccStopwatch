...
<div class="wrap">
  ...
  <div class="card">
    ...
    <div class="step"><div class="num">2</div><div class="t"><b>設定課表與組別</b><div class="d">場地一圈幾m、距離×趟數、目標秒、間休；點顏色開關各組（黃=第1組…紅=第6組），可展開逐組自訂組數/目標/休息</div></div></div>
    <div class="step"><div class="num">2+</div><div class="t"><b>組合 / 金字塔課表</b><div class="d">一個項目可「＋加一個距離」組成 (400m+200m)×N；金字塔輸入前半段(如 1200→800→400)後按「鏡像(金字塔)」一鍵對稱補成 1200→800→400→800→1200</div></div></div>
